...
> Phase numbering is historical: former Phases 2, 4 and 5 were folded into
> Phases 3 and 6 during earlier revisions. The remaining numbers (0, 1, 3, 6)
> are kept stable because cross-references cite them.
...
**WCAG contrast check (via `$SKILL_DIR/bin/contrast-check.sh`):** for each brand hex
