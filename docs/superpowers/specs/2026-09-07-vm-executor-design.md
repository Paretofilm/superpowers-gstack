...
- **Kontrakten plugin-en skal bygge mot** er den som står under «Kontrakten mellom lag 2 og
  ...
  ruting uten VM.
- **Fase 1 er implementert i 2.53.0** (denne PR-en). Fase 2–3 er ikke påbegynt.
  Versjonsnumrene under forskjøv seg ett hakk: 2.52.0 gikk til `/spec-drift`, så fase 1
  ble 2.53.0, fase 2 blir 2.54.0 og fase 3 blir 2.55.0. Riggen skal gå mot
...
### Fase 1 — Plugin: ruting + runner + markør (`superpowers-gstack` 2.53.0)
...
- `skills/macos-e2e-scaffold/SKILL.md` — runner-mal v2 (`# Auto-generated by
  /macos-e2e-scaffold v2.53.0`): leser `.gstack/e2e-executor`, `command -v vm-e2e`, dispatcher
...
- `CLAUDE.md` (rutingseksjonen), `README.md`, `CHANGELOG.md` `## [2.53.0]`,
...
### Fase 2 — Flakiness-skill (`/superpowers-gstack:e2e-flake`, 2.54.0)
...
### Fase 3 — Asynkron E2E som plan-konvensjon (2.55.0, valgfri)
